...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // CSP Compliance: Attach click handlers to buttons here instead of inline HTML 'onclick'
  ...
  const backBtn = document.querySelector('#step-otp .btn-ghost');
